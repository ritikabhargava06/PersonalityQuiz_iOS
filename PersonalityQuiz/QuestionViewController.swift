...
class QuestionViewController: UIViewController {
    ...
    var questions:[Question]=[
        Question(question: "Which food do you like the most?", type: .single, answers: [
            Answer(text: "Steak", type: .dog),
            Answer(text: "Fish", type: .cat),
            Answer(text: "Carrots", type: .rabbit),
            Answer(text: "Corn", type: .turtle)]),
        Question(question: "What activities do you enjoy?", type: .multiple, answers: [
            Answer(text: "Swimming", type: .turtle),
            Answer(text: "Sleeping", type: .cat),
            Answer(text: "Cuddling", type: .rabbit),
            Answer(text: "Eating", type: .dog)]),
        Question(question: "How much do you enjoy car rides?", type: .ranged, answers: [
    ...
    func updateUI(){
        ...
        case .ranged:
            updateRangedStack(answers: currentAnswers)
        }
    }
    ...
    func updateRangedStack(answers:[Answer]){
